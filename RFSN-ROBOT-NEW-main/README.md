...
### Pick → Turn → Place demo

This build includes an additional task variant: **pick_turn_place**.

What it does:
- pick up the cube
- rotate ~90° about world Z while holding it (TURN)
- move to the place waypoint
- lower → release → retreat

Headless runner (no viewer required):
